...
function firstJourneyDone(){let p=profile();if(!p)return home();if(p.done.length>0){alert("🌱 You've already completed your first KindStep!");return home();}p.firstJourneyDone=true;p.done.push("first-step");p.points+=100;save();alert("🌱 Brilliant! One small win completed.");home();}
