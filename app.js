...
function firstJourneyDone(){let p=profile();if(!p)return home();if(!p.firstJourneyDone){p.firstJourneyDone=true;p.points+=100;save();}alert("🌱 Brilliant! You completed One Small Win!");home();}
